...
module.exports = {
  ...
  "entry": {
    ...
    "scripts": [
      "script-loader!./src/assets/jquery/jquery-3.2.1.slim.min.js",
      "script-loader!./src/assets/tether/tether.min.js",
      "script-loader!./src/assets/b4/js/bootstrap.min.js"
    ],
    "styles": [
      "./src/styles.css",
    ...
    "rules": [
      ...
      },
      {
        "exclude": [
          ...
          path.join(process.cwd(), "src/assets/b4/css/bootstrap.min.css")
        ],
        "test": /\.css$/,
        "use": [
